...
-- Tiempo de generación: 06-02-2021 a las 12:37:05
...
CREATE TABLE `escuelas_primarias` (
  ...
  `Estado` varchar(60) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `Sector` varchar(60) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `Categoria` varchar(15) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `Ambito` varchar(60) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `SedeSupervision` varchar(60) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `OfertaTipo` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `Localidad` varchar(26) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `Departamento` varchar(128) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `Domicilio` varchar(128) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `escuelas_primarias` (`Id`, `Cue`, `Anexo`, `Nombre`, `Estado`, `Sector`, `Categoria`, `Ambito`, `SedeSupervision`, `OfertaTipo`, `Localidad`, `Departamento`, `Domicilio`, `Telefono`) VALUES
...
(22, 4600044, 0, 'ESC.N°174 \"PROVINCIA DE SALTA\"J.C.', 'Activo', 'Estatal', '1°', 'URBANA', 'ZONA  1D', 'Común - Jardín de infantes , Común - Primaria de 7 años', 'AIMOGASTA', 'ARAUCO', 'IMELDA ROMERO 694, TALACAN (F5310)', '03827-429019'),
...
(57, 4600105, 0, 'ESC.N°024 \"PROVINCIA DEL NEUQUEN\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  15', 'Común - Primaria de 7 años', 'SALICAS', 'SAN BLAS DE LOS SAUCES', 'RUTA NAC.N°40 , (F5327)', ''),
...
(64, 4600120, 0, 'ESC.N°004 \"PROVINCIA DE CORDOBA\"J.C.', 'Activo', 'Estatal', '1°', 'URBANA', 'ZONA  9', 'Común - Primaria de 7 años', 'PLAZA NUEVA', 'FAMATINA', 'AVDA.SAN PEDRO S/Nº, JARDIN (F5365)', '03825-493650'),
...
(67, 4600125, 0, 'ESC.N°057 \"BERNARDINO RIVADAVIA\"J.C.', 'Activo', 'Estatal', '2°', 'R.A. ', 'ZONA  6', 'Común - Primaria de 7 años', 'PINCHAS', 'CASTRO BARROS', 'RUTA PCIAL.N°75 , (F5301)', ''),
...
(71, 4600139, 0, 'ESC.N°062 \"SOBERANIA ARGENTINA\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  15', 'Común - Primaria de 7 años', 'LOS ROBLES', 'SAN BLAS DE LOS SAUCES', 'RUTA NAC.N°40 , (F5329)', ''),
...
(74, 4600143, 0, 'ESC.N°019 \"DOMINGO MATHEU\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  6', 'Común - Primaria de 7 años', 'AMINGA', 'CASTRO BARROS', 'AVDA.PEDRO I.DE CASTRO BARROS S/N°, (F5301)', '03827-494600'),
(75, 4600145, 0, 'ESC.N°103 \"CORONEL NICOLAS BARROS\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  6', 'Común - Primaria de 7 años', 'ANILLACO', 'CASTRO BARROS', 'CORONEL NICOLAS BARROS S/N°, VIRGEN DE FATIMA (F5301)', '03827-482025'),
(76, 4600147, 0, 'ESC.N°270 \"BELINDO DE LA FUENTE\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  6', 'Común - Primaria de 7 años', 'ANJULLON', 'CASTRO BARROS', 'JOAQUIN V.GONZALEZ S/N°, (F5303)', '03827-490555'),
...
(78, 4600150, 0, 'ESC.N°064 \"JUSTO JOSE DE URQUIZA\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  9', 'Común - EGB 1 y 2 , Común - Primaria de 7 años', 'PITUIL', 'FAMATINA', 'SANTO DOMINGO S/N°, LA PLAZA (F5361)', '03825-C/P484090'),
(79, 4600151, 0, 'ESC.N°044 \"FILOMENA NAVARRO DE GONDOLO\"J.C.', 'Activo', 'Estatal', '2°', 'R.A. ', 'ZONA  15', 'Común - Primaria de 7 años', 'CHAUPIHUASI', 'SAN BLAS DE LOS SAUCES', 'RUTA NAC.N°40 , (F5327)', '03827-497112'),
(80, 4600152, 0, 'ESC.N°277 \"FLAVIANO DE LA COLINA\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  15', 'Común - Primaria de 7 años', 'SCHAQUI', 'SAN BLAS DE LOS SAUCES', 'RUTA NAC.N°40 , (F5329)', ''),
...
(89, 4600168, 0, 'CENTRO EDUCATIVO AICUÑA(EX-ESC.N°068\"ARSENIO SALINAS\")', 'Activo', 'Estatal', '3°', 'R.A. ', 'ZONA  7', 'Común - Jardín de infantes , Común - Primaria de 7 años , Común - Secundaria Completa req. 7 años', 'AICUÑA', 'CORONEL FELIPE VARELA', 'PRINCIPAL S/N°, (F5361)', '03825-483001C/P'),
...
(137, 4600254, 0, 'ESC.N°301 \"GENDARMERIA NACIONAL\"J.C.', 'Activo', 'Estatal', '3°', 'R.D.', 'ZONA  7', 'Común - Jardín de infantes , Común - Primaria de 7 años , Común - Solo Secundaria Básica req. 7 años', 'POTRERO GRANDE', 'VINCHINA', 'PRINCIPAL S/N°, (F5359)', '03825-450201C/P'),
...
(182, 4600322, 0, 'ESC.N°073 \"VICENTE CALDERON\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  7', 'Común - Jardín de infantes , Común - Primaria de 7 años', 'VILLA SAN JOSE DE VINCHINA', 'VINCHINA', 'AVDA.CARLOS SAUL MENEM S/N°, LA PUNILLA (F5357)', '03825-494830'),
...
(302, 4600487, 0, 'ESC.N°080 \"PROVINCIA DE LA PAMPA\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  8', 'Común - Primaria de 7 años', 'TAMA', 'GENERAL ANGEL V PEÑALOZA', '7 DE OCTUBRE S/N, CENTRO (F5385)', '03826-490334'),
...
(305, 4600493, 0, 'ESC.N°186 \"CORONEL FELIPE VARELA\"J.C.', 'Activo', 'Estatal', '2°', 'R.A. ', 'ZONA  11', 'Común - Primaria de 7 años', 'LOMA BLANCA', 'GENERAL BELGRANO', 'EX.RUTA 79.AVDA.ANGEL VICENTE PEÑALOZA , (F5383)', ''),
...
(309, 4600498, 0, 'ESC.N°027 \"GOBERNACION DE STA.CRUZ\"J.C.', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  4', 'Común - Primaria de 7 años', 'ULAPES', 'GENERAL SAN MARTIN', 'AVDA.SAN MARTIN S/N°, CENTRO (F5473)', '0380-4491830'),
...
(327, 4600523, 0, 'ESC.N°281 \"25 DE MAYO\"J.C.', 'Activo', 'Estatal', '3°', 'R.D.', 'ZONA  3', 'Común - Primaria de 7 años', 'COLONIA ORTIZ DE OCAMPO', 'GENERAL OCAMPO', 'PUBLICA S/N°, (F5275)', '03826-496054C/P'),
(328, 4600524, 0, 'ESC.N°267 \"GRAL.ANGEL VICENTE PEÑALOZA\"J.C.', 'Activo', 'Estatal', '1°', 'URBANA', 'ZONA  11', 'Común - Primaria de 7 años', 'OLTA', 'GENERAL BELGRANO', 'SAN MARTIN 150, LA PLAZA (F5383)', ''),
...
(341, 4600583, 0, 'ESC.MUNICIPAL N°1\"JUAN MANUEL FANGIO\"', 'Activo', 'Estatal', '1°', 'URBANA', 'ZONA  1A', 'Común - Primaria de 7 años', 'LA RIOJA', 'CAPITAL', 'NICOLAS DAVILA S/N°, HOSPITAL (F5300)', '0380-4474256'),
...
(343, 4600699, 0, 'ESC.MUNICIPAL N°2\"JUAN DOMINGO PERON\"', 'Activo', 'Estatal', '1°', 'R.A. ', 'ZONA  1F', 'Común - Jardín de infantes , Común - Primaria de 7 años', 'LA RIOJA', 'CAPITAL', 'RUTA NAC.N°75 KM 15 , LA QUEBRADA (F5300)', ''),
